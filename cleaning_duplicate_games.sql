SELECT count(*) FROM `gamingprofilesproject.xbox_kaan.xbox_games` 
group by title, developers, publishers,genres,supported_languages,release_date
having count(*)>1;
...
select * from `gamingprofilesproject.xbox_kaan.xbox_games_clean`